...
<head>
	...
	<title>Elite_Support! <?php echo $__env->yieldContent("title"); ?></title> 
						...
						<ul class="navbar-nav navbar-nav-right">
							<li class="nav-item nav-profile dropdown" style="float: right;">
								...
								<div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
									<a  class="dropdown-item" href="http://ashokleyland.localhost/non_elitesupport/autologin?id=<?php echo e(base64_encode(Auth::user()->id)); ?>" ><i class="fa fa-exchange" aria-hidden="true"></i>
										Standard Support
									</a>
									<a class="dropdown-item" href="<?php echo e(url('reset-password')); ?>">
    ...
    <ul class="navbar-nav mr-auto"> <!--mr-auto,mx-auto-->    	
		...
		<li class="nav-item dropdown">
			...
			<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				...
				<a class="dropdown-item" href="<?php echo e(url('users')); ?>">Manage Users</a>
				<a class="dropdown-item" href="<?php echo e(url('vehicle')); ?>">Manage Vehicle </a>
				<a class="dropdown-item" href="<?php echo e(url('role')); ?>">Manage Roles</a>
				<a class="dropdown-item" href="<?php echo e(url('dealer')); ?>">Manage Dealer</a>
				<a class="dropdown-item" href="<?php echo e(url('owner-view')); ?>">Manage Owner</a>
				<a class="dropdown-item" href="<?php echo e(url('owner-contact-view')); ?>">Manage Customer Contact</a>
				<a class="dropdown-item" href="<?php echo e(url('escalation')); ?>">Manage Escalation</a>
							
				<a class="dropdown-item" href="<?php echo e(url('change-password')); ?>">Change User Password</a>
		...
		<li class="nav-item dropdown"> 
			...
			<div class="dropdown-menu" aria-labelledby="navbarDropdown">
				<?php if(Auth::user()->role == '29' || Auth::user()->role == '30'): ?>
				<a class="dropdown-item" href="<?php echo e(url('region-view')); ?>">Manage Zone</a>
				<a class="dropdown-item" href="<?php echo e(url('state-view')); ?>">Manage Region</a>
				<a class="dropdown-item" href="<?php echo e(url('city-view')); ?>">Manage Area</a>
				<?php endif; ?>
		...
		<li class="nav-item dropdown">
 		...
 		<?php endif; ?>
		<?php if(Auth::user()->role == '78'): ?>
		 <li class="nav-item ">
			 <a class="nav-link" href="<?php echo e(url('asm-user')); ?>">
				 <span class="menu-title">ASM User</span>
			 </a>
		 </li>
		 <li class="nav-item ">
			 <a class="nav-link" href="<?php echo e(url('asm-dealer')); ?>">
				 <span class="menu-title">ASM Dealer</span>
			 </a>
		 </li>
		 
	 <?php endif; ?>
	 <?php if(Auth::user()->role == '79'): ?>
		 <li class="nav-item ">
			 <a class="nav-link" href="<?php echo e(url('rsm-user')); ?>">
				 <span class="menu-title">RSM USER</span>
			 </a>
		 </li>
		 <li class="nav-item ">
			 <a class="nav-link" href="<?php echo e(url('rsm-dealer')); ?>">
	 ...
	 <li class="nav-item dropdown">
		...
		<div class="dropdown-menu" aria-labelledby="navbarDropdown">
			<a class="dropdown-item" href="<?php echo e(url('psf-import')); ?>">Upload Data</a>
			<a class="dropdown-item" href="<?php echo e(url('psf-list')); ?>">List</a>
			<a class="dropdown-item" href="<?php echo e(url('psf-report')); ?>">Datewise Report</a>
			<a class="dropdown-item" href="<?php echo e(url('psf-list-report')); ?>">Download Not Attempt Report</a>
			<a class="dropdown-item" href="<?php echo e(url('psf-complaint-report')); ?>">Download Complaint Log Report</a>
			
		</div>
	</li>
	<?php endif; ?>
	
	<?php if(Auth::user()->user_type_id== '3' || Auth::user()->user_type_id== '2'): ?>
	<li class="nav-item dropdown">
		<a class="nav-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">PSF SURVEY
			<i class="fa fa-angle-down" style="margin-left: 5px;"></i>
		</a>
		<div class="dropdown-menu" aria-labelledby="navbarDropdown">
			<a class="dropdown-item" href="<?php echo e(url('dealer-complaint-list')); ?>">Complaint</a>
...
.fatch{
   ...
   <?php /**PATH D:\wamp64\www\ashokleyland\elitesupport\resources\views/layouts/masterlayout.blade.php ENDPATH**/ ?>