		...
		<tbody>
			<?php if(isset($rowData)): ?>
				...
				<tr>
					...
					<td class="cls_id"><?php echo e($row->owner_name); ?></td>
					<td class="cls_id"><?php echo e($row->dealer_name); ?></td>
					<td class="cls_id"><?php echo e($row->remark_type); ?></td>
					<?php if($row->tat_scheduled !=''): ?>
					<td class="cls_id"><?php echo e(date('d-m-Y H:i:s',strtotime($row->tat_scheduled))); ?></td>
					<?php else: ?>
					...
					<td class="cls_id"><?php echo e($row->actual_response_time !=''?date('d-m-Y H:i:s',strtotime($row->actual_response_time)):'NA'); ?></td>
...
exportOptions: { modifier: { page: 'all'} }
	...
	<?php /**PATH D:\wamp64\www\ashokleyland\elitesupport\resources\views/dashboard_table.blade.php ENDPATH**/ ?>