						...
						<form name="myForm" method="post" enctype="multipart/form-data" action="{{url('store-update-cases')}}">
							...
							<div class="row">
								...
								<div class="form-group col-md-3">
									...
									@endphp --}}
									<input type="text" name="actual_response_time" id="actual_response_time" autocomplete="off" class="form-control" value="{{$actual_response_time}}"  onblur="estimatedChange(this.value)">
