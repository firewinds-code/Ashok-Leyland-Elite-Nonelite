...
<div class="row"  id="freshform">
    <form name="myFresh" method="post" enctype="multipart/form-data" action="{{route('cogent-dealer-update')}}">
    ...
    <script>
        function getFreshForm (type1,type2,lang){
                console.log("Call Lang");
                    let typeData ="Lang";
                    $.ajax({
                        url: "{{route('cogent-dealer-lang-ajax')}}",
                        type: 'post',
                        data: {
                        "_token": "{{ csrf_token() }}",
                        type1: type1,
