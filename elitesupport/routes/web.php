...
use App\Http\Controllers\PsfImportController;
/* PSF Controller */
/*
|--------------------------------------------------------------------------
| Web Routes
...
Route::middleware([
 ...
 Route::get('asm-user', [UserController::class, 'asmUser'])->name('asm-user');
Route::get('rsm-user', [UserController::class, 'rsmUser'])->name('rsm-user');
...
Route::post('store-change-password', [UserController::class, 'storeChangePassword'])->name('store-change-password');
  // USER MANAGEMENT
   ...
   Route::get('asm-dealer', [DealerController::class, 'asmDealer'])->name('asm-dealer');
    Route::get('rsm-dealer', [DealerController::class, 'rsmDealer'])->name('rsm-dealer');
   /* DealerController */
   ...
   Route::get('dialer-test', [LocationController::class, 'dialertest'])->name('dialer-test');
   /* LocationController */
   ...
   /* FOLLOWUP COGENT CRM*/
    ...
    /* FOLLOWUP COGENT CRM*/
    /* psf controller  work start 07-06-2023 by Devendra Developer  */

    Route::get('psf-list', [PsfController::class, 'index'])->name('psf-list');
    Route::get('update-psf-query/{id}', [PsfController::class, 'create'])->name('update-psf-query');
    Route::post('psf-query-update', [PsfController::class, 'store'])->name('psf-query-update');
    Route::post('psf-dealer-update', [PsfController::class, 'updateDealer'])->name('psf-dealer-update');
    Route::get('psf-import', [PsfImportController::class, 'import'])->name('psf-import');
    Route::post('psf/uploadfile', [PsfImportController::class, 'storeImportExcel'])->name('psf/uploadfile');
    Route::get('dealer-complaint-list', [PsfController::class, 'complaintList'])->name('dealer-complaint-list');
    Route::get('dealer-survey-list', [PsfController::class, 'surveyList'])->name('dealer-survey-list');
    Route::get('dealer-survey-query/{id}', [PsfController::class, 'surveyForm'])->name('dealer-survey-query');
    Route::get('dealer-complaint-query/{id}', [PsfController::class, 'complaintForm'])->name('dealer-complaint-query');
    

    Route::get('psf-report/', [PsfController::class, 'psfReport'])->name('psf-report');
    Route::post('store-psf-report/', [PsfController::class, 'storePsfReport'])->name('store-psf-report');
    Route::post('store-psf-list/', [PsfController::class, 'storePSFList'])->name('store-psf-list');
    Route::get('psf-complaint-report', [PsfController::class, 'psfReportForComplaintNo'])->name('psf-complaint-report');
    Route::get('psf-list-report', [PsfController::class, 'psfListReport'])->name('psf-list-report');
    /* psf controller  work start 07-06-2023 by Devendra Developer  */
