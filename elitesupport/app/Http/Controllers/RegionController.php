...
/* ----------------------caller---------------------------------  */	
	...
	public function storeZone(Request $request){
		try{
			...
			if ($dataid =='') {
					...
					DB::table('non_elitesupport.mstr_region')->insert(['region'=>$region]); 
					$notification = array(
				...
				DB::table('non_elitesupport.mstr_region')->where('id', $dataid)->update(['region'=>$region,'updated_at'=>$updated_at]);
				$notification = array(
	...
	public function zoneDelete($id){
		try{
			...
			DB::table('mstr_region')->where('id', $id)->delete();
			DB::table('non_elitesupport.mstr_region')->where('id', $id)->delete();
			$notification = array(
		        'message' => "Region Delete Succeddfully",
    ...
    public function storeState(Request $request){
		try{
			...
			if ($dataid =='') {
				...
				DB::table('non_elitesupport.mstr_state')->insert(['region_id'=>$region_id,'state'=>$state]);
				$notification = array(
					'message' => 'Stored successfully',
					'alert-type' => 'success'
				);
				...
				DB::table('non_elitesupport.mstr_state')->where('id', $dataid)->update(['region_id'=>$region_id,'state'=>$state,'updated_at'=>$updated_at]);
				$notification = array(
					'message' => 'Updated successfully',
					'alert-type' => 'success'
				);
    ...
    public function stateDelete($id){
		try{
			...
			DB::table('mstr_state')->where('id', $id)->delete();
			DB::table('non_elitesupport.mstr_state')->where('id', $id)->delete();
			$notification = array(
		...
		try{
			...
			if ($dataid =='') {
				...
				if(sizeof($checkCity) > 0){
					...
					DB::table('non_elitesupport.mstr_city')->insert(['region_id'=>$region_id,'state_id'=>$state_id,'city'=>$city]);
					$notification = array(
						'message' => 'Stored successfully',
						'alert-type' => 'success'
					);
				...
				DB::table('non_elitesupport.mstr_city')->where('id', $dataid)->update(['region_id'=>$region_id,'state_id'=>$state_id,'city'=>$city,'updated_at'=>$updated_at]);
				$notification = array(
					'message' => 'Updated successfully',
					'alert-type' => 'success'
				);
    ...
    public function cityDelete($id){
		try{
			...
			DB::table('mstr_city')->where('id', $id)->delete();
			DB::table('non_elitesupport.mstr_city')->where('id', $id)->delete();
			$notification = array(
