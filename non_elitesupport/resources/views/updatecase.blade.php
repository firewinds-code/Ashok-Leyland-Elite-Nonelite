						...
						<form name="myForm" method="post" enctype="multipart/form-data" action="{{url('store-update-cases')}}" onsubmit="return formSubmit()">
							...
							<div class="row">
								...
								<div class="form-group col-md-6">
									...
									<select name="assign_to" id="assign_to" class="form-control" onchange="getAssignMob(this.value),getAssignWorkManager(this.value,''),getNightSpoc(this.value,'')"  {{(Auth::user()->role == 29 || Auth::user()->role == 30 || Auth::user()->role == 87 || Auth::user()->role == 78)?"":"disabled"}}>
										<option value="NA">--Select--</option>
										@isset($sqlLatLong)
