...
@section('bodycontent')
                ...
                <div class="row">
                    <div class="col-md-8" style="border: 1px solid #ccc">
                            ...
                            <div class="row" style="margin-bottom: 10px;">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="chassis_number" id="chassis_number" class="form-control"
                                        onblur="checkChassisNumber1()" placeholder="Chassis Number" />
                                ...
                                <div class="form-group col-md-3">
                                    <a class="btn-secondary"
                                        onclick="getData(reg_number.value,chassis_number.value,engine_number.value);"
                                        style="color: #fff;padding: 5px;border-radius: 10px;position: relative;top: 30px;"
                                        id="getsearch">Search</a>
                                    <a class="btn-secondary" onclick="reloadPage();"
                                        style="color: #fff;padding: 5px;border-radius: 10px;position: relative;top: 30px;">Reset</a>
                        ...
                        <form name="myForm" id="myForm" method="post" enctype="multipart/form-data"
                            action="{{ url('ticket-creation-data') }}" onsubmit="return formSubmit()">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="reg_number1" id="reg_number1" class="form-control"
                                ...
                                <div class="form-group col-md-3">
                                    <label for="datefrom">Chassis Number</label>
                                    <span style="color: red;">*</span>
                                    <input type="text" name="chassis_number1" id="chassis_number1" class="form-control"
                                        placeholder="Chassis Number" onblur="checkChassisNumber()" />
                                    <span id="chassis_number1_error" style="color:red"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="datefrom">Engine Number</label>
                                    <span style="color: red;">*</span>
                                    <input type="text" name="engine_number1" id="engine_number1" class="form-control"
                                        placeholder="Engine Number" />
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <span style="color: red;">*</span>
                                    <input type="text" name="vehicle_segment" id="vehicle_segment"
                                        class="form-control" placeholder="Vehicle Segment" />
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="purchase_date" id="purchase_date" autocomplete="off"
                                        class="form-control"
                                        value="@isset($purchase_date){{ $purchase_date }} @endisset"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="add_blue_use" id="add_blue_use" class="form-control"
                                        onchange="addBlueUse(this.value)">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <span style="color: red;">*</span>
                                    <input type="text" name="engine_emmission_type" id="engine_emmission_type"
                                        class="form-control">
                                    <select name="engine_emmission_type" id="engine_emmission_type1" class="form-control"
                                ...
                                <div class="col-sm-12 text-center">
                                    <a class="btn-secondary" id="vehicleEdit"
                                        onclick="vehicleUpdate(ownerId.value,reg_number1.value,chassis_number1.value,engine_number1.value,vehicle_model.value,vehicle_segment.value,purchase_date.value,add_blue_use.value,engine_emmission_type.value);"
                                        style="display: none; color: #fff;padding: 5px;border-radius: 10px;position: relative;top: 10px;">Save
                                        Vehicle</a>
                                    <img src="{{ asset('images/left.gif') }}" width="5%" id="vehicleIndication"
                                        style="display:none" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="owner_name" id="owner_name_text" class="form-control"
                                        placeholder="Name" style="display:none" disabled />
                                    <select name="owner_name" id="owner_name" class="form-control" placeholder="Name"
                                        onchange="ownerContactNameData(this.value)" required>
                                        <option value="">--Select--</option>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="owner_mob" id="owner_mob" class="form-control"
                                        placeholder="Mobile Number" maxlength="10" readonly />
                                ...
                                <input type="hidden" name="owner_company" id="owner_company" class="form-control"
                                ...
                                <div class="form-group col-md-3" style="display:none">
                                    ...
                                    <input type="text" name="alse_mail" id="alse_mail" class="form-control"
                                        placeholder="ALSE Email" value="test@dispostable.com" />
                                ...
                                <div class="form-group col-md-3" style="display:none">
                                    ...
                                    <input type="text" name="asm_mail" id="asm_mail" class="form-control"
                                        placeholder="RSM Email" value="test@dispostable.com" />
                            ...
                            <div class="row">
                                <div class="container-fluid">
                                    <div class="col-sm-12 text-center">
                                        <a class="btn-secondary" id="ownerEdit"
                                            onclick="ownerUpdate(owner_name_text.value,owner_mob.value);"
                                            style="display: none; color: #fff;padding: 5px;border-radius: 10px;position: relative;top: 10px;">Save
                                            Owner</a>
                                        <img src="{{ asset('images/left.gif') }}" width="5%" id="ownerIndication"
                                            style="display:none" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <span style="color: red;">*</span>
                                    <input type="tel" name="caller_contact" id="caller_contact" class="form-control"
                                        placeholder="Caller Contact Number" maxlength="10" pattern="[0-9]{10}"
                                        required />
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="datefrom">Alternative Number</label>
                                    <input type="tel" name="caller_contact_alt" id="caller_contact_alt"
                                        class="form-control" placeholder="Alternative Number" maxlength="10"
                                        pattern="[0-9]{10}" />
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-3" id="longDiv">
                                    ...
                                    <input type="text" name="long" id="long" class="form-control"
                                        ...
                                        onkeyup="manualGoogleMap(lat.value,long.value)" />
                                </div>
                            </div>
                            <div class="row">
                                <div class="container-fluid">
                                    <div class="col-sm-12 text-center">
                                        <a class="btn-secondary" id="callerEdit"
                                            onclick="callerUpdate(vehicleId.value,ownerId.value,callerId.value,caller_type.value,caller_name.value,caller_contact.value,caller_contact_alt.value,caller_language.value);"
                                            style="display: none; color: #fff;padding: 5px;border-radius: 10px;position: relative;top: 10px;">Save
                                            Caller</a>
                                        <img src="{{ asset('images/left.gif') }}" width="5%" id="callerIndication"
                                            style="display:none" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="state" id="state" class="form-control"
                                        onchange="functionStateChange(this.value,'');functionAssignDealer(this.value,'')"
                                        required>
                                        <option value="">--Select--</option>
                                        @isset($caller_state)
                            ...
                            <hr>
                            <div class="ribbon">Vehicle Breakdown Ticket Details @if (Auth::user()->role == '29' || Auth::user()->role == '30' || Auth::user()->role == '87')
                                    <span style="float: right;"><a href="#" id="myBtn"
                                            style="color:#fff;text-decoration: underline;">Dealer Info</a></span>
                                @endif
                            </div>
                            {{-- <!-------------------------- The Modal --> --}}
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="assign_to" id="assign_to" class="form-control"
                                        onchange="getAssignMob(this.value),getAssignWorkManager(this.value,''),getNightSpoc(this.value,'')"
                                        required>
                                        <option value="">--Select--</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="assign_work_manager" id="assign_work_manager" class="form-control"
                                        onchange="getAssignWorkManagerMobile(this.value)" required>
                                    </select>
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="datefrom">Work Manager Mobile</label>
                                    <input type="text" name="assign_work_manager_mobile"
                                        id="assign_work_manager_mobile" class="form-control" placeholder="Mobile Number"
                                        readonly onkeyup="checkWorkManagerMobile()" />
                                ...
                                @if ($currentTime > 2000 || $currentTime < 800)
                                    <div class="form-group col-md-3">
                                        ...
                                        <input name="night_spoc_1_name" id="night_spoc_1_name" class="form-control"
                                            readonly />

                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="night_spoc_1_number">Night SPOC 1 Number</label>
                                        <input name="night_spoc_1_number" id="night_spoc_1_number" class="form-control"
                                            readonly />
                                    </div>

                                    <div class="form-group col-md-3">
                                        <label for="night_spoc_2_name">Night SPOC 2 Name</label>
                                        <input name="night_spoc_2_name" id="night_spoc_2_name" class="form-control"
                                            readonly />

                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="night_spoc_2_number">Night SPOC 2 Number</label>
                                        <input name="night_spoc_2_number" id="night_spoc_2_number" class="form-control"
                                            readonly />
                                    </div>
                                @endif
                                <div class="form-group col-md-3">
                                    ...
                                    <select name="remark_type" id="remark_type" class="form-control" required>
                                        ...
                                        @isset($remark_type)
                                            @foreach ($remark_type as $row)
                                                @php $allowStatus = array(36,39); @endphp
                                                @if (
                                                    (Auth::user()->role == '29' || Auth::user()->role == '30' || Auth::user()->role == '87') &&
                                                        in_array($row->id, $allowStatus))
                                                    <option value="{{ $row->type }}">{{ $row->type }}</option>
                                                @else
                                                    @php $tictStatus = array(32,33,34,35,36,13); @endphp
                                                    @if (!in_array($row->id, $tictStatus) && in_array($row->id, $allowStatus))
                                                        <option value="{{ $row->type }}">{{ $row->type }}</option>
                                                    @endif
                                                @endif
                                            @endforeach
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <span style="color: red;">*</span>
                                    <input type="text" name="estimated_response_time" id="estimated_response_time"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="actual_response_time" id="actual_response_time"
                                        autocomplete="off" class="form-control">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="tat_scheduled" id="tat_scheduled" autocomplete="off"
                                        class="form-control">
                                ...
                                @if (Auth::user()->role == '29' || Auth::user()->role == '30' || Auth::user()->role == '87')
                                    <div class="form-group col-md-3">
                                        ...
                                        <input type="text" name="actual_response_time_customer"
                                            id="actual_response_time_customer" autocomplete="off" class="form-control">
                                    </div>
                                    <div class="form-group col-md-3">
                                        <label for="datefrom">Actual Restoration Time as per Customer</label>
                                        <input type="text" name="tat_scheduled_customer" id="tat_scheduled_customer"
                                            autocomplete="off" class="form-control">
                                    </div>
                                @endif
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <span style="color: red;">*</span>
                                    <input type="text" name="followup_time" id="followup_time" autocomplete="off"
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="datefrom">Remarks ({{-- Max 500 Chars --}} Don't put it special char and
                                        press enter for new line )<sup style="color: red;">*</sup></label>
                                    <textarea name="assign_remarks" id="assign_remarks" cols="30" rows="5" class="form-control"
                                        onkeydown="return (event.keyCode!=13 && event.keyCode!=222);"></textarea>
                                    <span id="engine_number_error" style="color:red"></span>
                                </div>
                            </div>
                            <br />
                    ...
                    <div class="col-md-4" style="border: 1px solid #ccc">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                <label for=""></label>
                                <a class="btn-secondary" onclick="getLocation(phoneNumber.value);"
                                    style="color: #fff;padding: 5px 12px 5px 12px;border-radius: 10px;position: relative;top: 30px;">Send</a>
                                <a class="btn-secondary" onclick="my_function();"
                                    style="color: #fff;padding: 5px;border-radius: 10px;position: relative;top: 30px;">Get
                                    Location</a>
                            </div>
                        </div>
                        <hr>
    ...
    <script>
        ...
        btn.onclick = function() {
            ...
            if (assign_to == '') {
                ...
                $.ajax({
                    url: '{{ url('dealer-search-function') }}',
                    data: {
                        'dealerId': assign_to
                    },
        ...
        function functionStateChange(stateId, ell) {
            $.ajax({
                url: '{{ url('get-caller-state-change') }}',
                data: {
                    'stateId': stateId
                },
                success: function(response) {
        ...
        function functionAssignDealer(stateId, ell) {
            ...
            $.ajax({
                url: '{{ url('get-assign-dealer-state-change') }}',
                data: {
                    'stateId': stateId
                },
                success: function(response) {
        ...
        function getData(reg_number, chassis_number, engine_number) { //  Vahan API Call
            ...
            if (reg_number == '' && chassis_number == '' && engine_number == '') {
                ...
                $.ajax({
                    url: '{{ url('check-registration-ticket') }}',
                    data: {
                                ...
                                success: function(res) {
                                    if (res == "Yes") {
                                        ...
                                        window.location.href =
                                            "https://helpline.ashokleyland.com/elitesupport/autologin?id={{ base64_encode(Auth::user()->id) }}";
                                    } else {
                                        $.ajax({
                                            ...
                                            success: function(result) {
                                                ...
                                                if (resVahan[0] == 'no') {
                                                    if (reg_number != '') {
                                                        $.ajax({
                                                            ...
                                                            success: function(
                                                                ...
                                                                if (res1 ==
                                                                    ...
                                                                    alert(
                                                                        "VAHAN server error. Enter data manually and create ticket for Ashok Leyland vehicle only!!!"
                                                                        );
                                                                    $('#chassis_number1')
                                                                        .prop(
                                                                            'readonly',
                                                                    ...
                                                                    alert(
                                                                        "Enter Chassis Number isn't a Ashokleyland!!! Ticket creation restricted"
                                                                        );
                                                                    $('#submit')
                                                                        .hide();
                                                                    $('#callerEdit')
                                                                    ...
                                                                    'lcv') {
                                                                    alert(
                                                                        "Entered registration number is AL LCV model vehicle!!! Ticket creation restricted"
                                                                        );
                                                                    $('#submit')
                                                                        .hide();
                                                                    $('#callerEdit')
                                                                    ...
                                                                    alert(
                                                                        "Data not available in VAHAN for this registration no. Check once again then enter data manually and create ticket for Ashok Leyland vehicle only!!!"
                                                                        );
                                                                    $('#reg_number1')
                                                                        .prop(
                                                                            'readonly',
                                                                    ...
                                                                    if (chassis_numberCheck ==
                                                                        ...
                                                                        alert
                                                                            (
                                                                                "Entered registration number is not a AL vehicle!!! Ticket creation restricted"
                                                                                );
                                                                        $('#reg_number1')
                                                                            .prop(
                                                                                'readonly',
                                                        ...
                                                        $('#reg_number1').prop(
                                                            'readonly', false);
                                                        $('#chassis_number1').prop(
                                                            'readonly', false);
                                                        $('#engine_number1').prop(
                                                            'readonly', false);
                                                        $('#vehicle_model').prop(
                                                            'readonly', false);
                                                        $("#vehicle_segment").prop(
                                                            'readonly', false);
                                                        $("#purchase_date").prop(
                                                            'readonly', false);
                                                        $("#add_blue_use").prop(
                                                        ...
                                                        $('#engine_emmission_type1')
                                                            .prop('readonly', false);
                                                        $('#owner_name_text').prop(
                                                            'readonly', false);
                                                        $('#owner_mob').prop('readonly',
                                                            false);
                                                        ...
                                                        $("#engine_emmission_type1")
                                                            .prop('disabled', false);
                                                        $("#contact_name_text").prop(
                                                            'disabled', false);
                                                        $("#owner_name_text").prop(
                                                            'disabled', false);

                                                        $("#contact_name_select").prop(
                                                            'disabled', true);
                                                        $("#owner_mob").prop('readonly',
                                                            false);
                                                        $("#owner_landline").prop(
                                                            'readonly', false);
                                                        $("#owner_cat").prop('readonly',
                                                            false);
                                                        $("#owner_contact_mob").prop(
                                                            'readonly', false);
                                                        $("#owner_contact_email").prop(
                                                            'readonly', false);
                                                        $('#vahan_status').val('');
                                                    ...
                                                    if (resVahan[0] == 'notcreate') {
                                                        ...
                                                        $("#add_blue_use").val(resVahan[
                                                            10]);
                                                        $('#engine_emmission_type1')
                                                            .val(resVahan[6]);
                                                        $('#owner_name_text').val(
                                                            resVahan[7]);
                                                        $('#owner_mob').val(resVahan[
                                                            8]);
                                                        ...
                                                        var res = result.split('~~');
                                                        $('#vehicleId').val(res[0]);
                                                        $('#chassis_number').val(res[
                                                            3]);
                                                        $('#engine_number').val(res[4]);
                                                        $('#reg_number1').val(res[2]);
                                                        $('#chassis_number1').val(res[
                                                            3]);
                                                        $('#engine_number1').val(res[
                                                            4]);
                                                        $('#vehicle_model').val(res[1]);
                                                        $('#vehicle_segment').val(res[
                                                            5]);
                                                        $('#purchase_date').val(res[6]);
                                                        $('#add_blue_use').val(res[7]);
                                                        $('#engine_emmission_type').val(
                                                            res[9]);
                                                        /* $('#owner_name').val(res[10]); */
                                                        var ownerName = res[11];
                                                        // alert(res[10]);
                                                        $('#owner_name').append(
                                                            `<option value="${res[10]}" selected>${res[11]}</option>`
                                                        );
                                                        var ownerId = res[10];
                                                        var contact_name = res[29];
                                                        $('#owner_mob').val(res[12]);
                                                        $('#owner_landline').val(res[
                                                            13]);
                                                        $('#owner_cat').val(res[14]);
                                                        $('#owner_company').val(res[
                                                            15]);
                                                        $('#ownerId').val(res[10]);
                                                        $('#alse_mail').val(res[31]);
                                                        $('#asm_mail').val(res[32]);
                                                        var ownerId = res[10];
                                                        $('#owenerContactId').val(res[
                                                            16]);
                                                        $('#owner_contact_mob').val(res[
                                                            17]);
                                                        $('#contact_name_select').val(
                                                            res[16]);
        ...
        function contactNameData(id) {
            ...
            /*  */
            $.ajax({
                url: '{{ url('get-owner-contact-change') }}',
                data: {
                    'owenerContactId': id
                },
                success: function(response) {
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    for (var i = 0; i < markers.length; i++) {
                        ...
                        /*********************************Distance Code**********************************************/
                        var contentString = "<html><body><div><p><h2>" + trailhead_name +
                            "</h2><br><span><b>Distance:</b> " + Math.round(distanceInMeters * 0.001) +
                            " Kms</span></p></div></body></html>";

                        var marker = new google.maps.Marker({
                            position: myLatlng,
                            map: map,
                            title: "Coordinates: " + latitude + " , " + lng + " | Dealer name: " +
                                trailhead_name
                        });
        ...
        function getAssignDetailsManually(zone, state) {
            ...
            $.ajax({
                url: '{{ url('get-assign-details-manually') }}',
                data: {
                    'zone': zone,
                    'state': state
                },
                ...
                success: function(response) {
                    if (response == 'No' || response == 0) {
                        ...
                        for (item1 in Result) {
                            ...
                            if (ell != '') {
                                if (Result2[1] == ell) {
                                    str += "<option value='" + Result3 + "' selected>" + cnt + ' ' + Result2[
                                        1] + "</option>";
                                } else {
                                    str += "<option value='" + Result3 + "'>" + cnt + ' ' + Result2[1] +
                                        "</option>";
                                }
                            } else {
                                str += "<option value='" + Result3 + "'>" + cnt + ' ' + Result2[1] +
        ...
        function callerUpdate(vehicleId, ownerId, callerId, caller_type, caller_name, caller_contact, caller_contact_alt,
            caller_language) {
            if (ownerId == '') {
                toastr.info("Please save owner info");
                $('#ownerIndication').show();
                    ...
                    if (caller_language != '') {
                        $.ajax({
                            ...
                            data: {
                                ...
                                'caller_contact_alt': caller_contact_alt,
        ...
        function vehicleUpdate(ownerId, reg_number1, chassis_number1, engine_number1, vehicle_model, vehicle_segment,
            purchase_date, add_blue_use, engine_emmission_type) {
            if (reg_number1 != '') {
                if (ownerId != '') {
                    ...
                    /* else if(vehicle_segment == ''){
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                'chassis_number1': chassis_number1,
                                'engine_number1': engine_number1,
                                'vehicle_model': vehicle_model,
                                'vehicle_segment': vehicle_segment,
                                'purchase_date': purchase_date,
                                'add_blue_use': add_blue_use,
                                'engine_emmission_type': engine_emmission_type,
                                'owner_id': ownerId
                            },
                            success: function(response) {
                                var res = response.split('~~');
        ...
        function ownerUpdate(owner_name_text, owner_mob, owner_company) {
            if (owner_name_text != '') {
                $.ajax({
                    url: '{{ url('owner-update') }}',
                    data: {
                        'owner_name': owner_name_text,
                        'owner_mob': owner_mob,
                        'owner_landline': "NA",
                        'owner_cat': "NA",
                        'owner_company': owner_name_text
                    },
                    success: function(response) {
                        var res = response.split('~~');
                        $('#ownerId').val(res[0]);
        ...
        function ownerContactUpdate(vehicleId, ownerId, owenerContactId, owner_contact_mob, owner_contact_email) {
            ...
            if (contactPersonName != '') {
                ...
                $.ajax({
                    url: '{{ url('owner-contact-update') }}',
                    data: {
                        'vehicleId': vehicleId,
                        'ownerId': ownerId,
                        'owenerContactId': owenerContactId,
                        'contact_name': contactPersonName,
                        'owner_contact_mob': owner_contact_mob,
            ...
            for (var i = 0; i < markers.length; i++) {
                ...
                if (lat != "NaN" && latitude != "NaN" && lng != "NaN") {
                    ...
                    if (dcp < 250000) {
                        ...
                        /*********************************Distance Code**********************************************/
                        var contentString = "<html><body><div><p><h2>" + trailhead_name +
                            "</h2><br><span><b>Distance:</b> " + dis + "</span></p></div></body></html>";
