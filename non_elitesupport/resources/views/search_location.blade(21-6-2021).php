						...
						<form name="myForm" id="myForm" method="post" enctype="multipart/form-data" action="{{url('ticket-creation-data')}}" onsubmit="return formSubmit()">
							...
							<div class="row" >
								...
								<div class="form-group col-md-3">
									...
									<input type="text" name="owner_mob" id="owner_mob" class="form-control"  placeholder="Mobile Number" maxlength="10" disabled/>
								...
								<div class="form-group col-md-3">
									...
									<input type="text" name="owner_landline" id="owner_landline" class="form-control"  placeholder="Landline Number" disabled/>
								...
								<input type="hidden" name="owner_company" id="owner_company" class="form-control"  placeholder="Campany Name"/>
								{{-- <div class="form-group col-md-3">
								...
								<div class="form-group col-md-3">
									...
									<input type="text" name="alse_mail" id="alse_mail" class="form-control"  placeholder="ALSE Email" disabled/>
								...
								<div class="form-group col-md-3">
									...
									<input type="text" name="asm_mail" id="asm_mail" class="form-control"  placeholder="RSM Email" disabled/>
							...
							<div class="row" >
								...
								<div class="form-group col-md-3">
									...
									<input type="tel" name="owner_contact_mob" id="owner_contact_mob" class="form-control"  placeholder="Phone Number" maxlength="10" pattern="[0-9]{10}" disabled/>
									<input type="hidden" name="owner_contact_mob" id="owner_contact_mob" class="form-control" />
			                        <span id="engine_number_error" style="color:red"></span> 
			                    </div>
								<div class="form-group col-md-3">
			                        <label for="datefrom" >Email</label>
									<input type="email" name="owner_contact_email" id="owner_contact_email" class="form-control"  placeholder="Email"  disabled/>
...
function formSubmit(){
 		...
 		if(vehicleId ==''){
 			alert("Please save vehicle info");
 			return false;
 		}else if(ownerId == ''){
 			alert("Please save owner info");
 			return false;
 		}else if(owenerContactId == ''){
 			alert("Please save owner contact info");
 			return false;
 		}else if(callerId == ''){
 			alert("Please save caller info");
 			return false;
 		}else{
 			return true;
 		}
 ...
 /* *********************************Model***************************************** */
	...
	function getData(reg_number,chassis_number,engine_number){
		...
		$.ajax({ url: '{{url("check-registration-ticket")}}',
			...
			success: function(data){
				if(data =='Yes'){
					alert("Given vehicle ticket is open");
					$('#submit').hide();
