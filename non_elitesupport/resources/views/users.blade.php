                    ...
                    <div class="col-md-12">
							...
							<form name="myForm" method="post" enctype="multipart/form-data" action="{{url('store-users')}}" autocomplete="off">
								...
								<div class="row">
									...
									<div class="form-group col-md-3">
										...
										<input type="text" name="phonenumbers" id="phonenumbers"  class="form-control" placeholder="Mobile" required >
						...
						{{-- <div class="row">
							...
							<select name="fieldtype" id="fieldtype" class="form-control">
								<option value="">--Select--</option>
								<option value="EmployeeId">Login Id</option>
								<option value="Name">Name</option>
								
								<option value="Email">Email</option>
								<option value="Mobile">Mobile</option>
								<option value="code">SAC Code</option>
							</select>
							</div>
				...
				buttons: [
					{ 
						...
						exportOptions: { 
							...
							modifier: { search: 'none', /* selected: true, */page: 'all' }						
						}
					}
