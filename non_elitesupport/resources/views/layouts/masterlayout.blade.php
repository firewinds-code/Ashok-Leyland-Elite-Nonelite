...
<head>
	...
	{{-- <meta http-equiv="Content-Security-Policy" content="default-src *; style-src 'self' 'unsafe-inline'; script-src * 'unsafe-inline' 'unsafe-eval' https://maps.googleapis.com"> --}}
	
	<meta name="csrf-token" content="{{ csrf_token() }}" />
	<title>Standard_Support! @yield("title")</title> 
						...
						<ul class="navbar-nav navbar-nav-right">
							<li class="nav-item nav-profile dropdown" style="float: right;">
								...
								<div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
									<a  class="dropdown-item" href="http://ashokleyland.localhost/elitesupport/autologin?id={{base64_encode(Auth::user()->id)}}" ><i class="fa fa-exchange" aria-hidden="true"></i>
										ELite
									</a>
