...
@section('title','Standard Consolidated Closed Report')
@section('bodycontent')
<div class="content-wrapper mobcss">	 
	<div class="card">	            
	    <div class="card-body">
			<h4 class="card-title">Consolidated Closed Report</h4>
	        <div class="clear"></div>			
            <hr>
			
			<form name="myForm" method="post" enctype="multipart/form-data" action="{{url('store-consolidated-closed-report')}}">
						...
						<select name="ticketStatus[]" multiple id="ticketStatus" class="form-control" required>
							@if(isset($statusData))
								@foreach ($statusData as $row)
									@if(isset($ticketStatus) && $row->type == 'Closed')									
