                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group col-md-4">
                            <label for="cc_to">CC To</label> <span style="color: #ff0000">*</span>
                            <select name="cc_to[]" multiple="muliple" id="cc_to" class="form-control" style="height: 138px;">
                ...
                @isset($escalateData)   
                    ...
                    <tr>
						<td>
							...
							<a href="{{route('escalation_delete.escalationDelete', ['id' => $row->Escalation_id])}}" onclick="return confirm('Do you want to delete?')">
								<i class="fa fa-trash-o" aria-hidden="true" style="cursor: pointer;">
								</i>
							</a>
						</td>                                                          
