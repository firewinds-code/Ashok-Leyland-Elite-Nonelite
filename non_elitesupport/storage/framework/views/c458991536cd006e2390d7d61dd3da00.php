...
<?php $__env->startSection('title','Vehicle Master'); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                    	<div id="insertvehicle" >
							<form name="myForm" method="post" enctype="multipart/form-data" action="<?php echo e(url('store-vehicle')); ?>" onsubmit="return vehicleValidation()">
	                            ...
	                            <div class="row">
									...
									<div class="form-group col-md-3">
										...
										<select name="ownerId" id="ownerId" class="form-control" required>
											...
											<?php $__currentLoopData = $ownerData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e($row->id); ?>"><?php echo e($row->owner_name); ?></option>
                        ...
                        <div class="table-responsive">
							<div class="row">
								<div class="col-md-5"><a class="btn btn-warning" href="<?php echo e(route('export')); ?>" style="background-color: #e9e9e9;border: 1px solid #999;border-radius: 2px;">Excel</a></div>
                            ...
                            <table id="order-listing1" class="table">
                                ...
                                <?php $count=1; ?>
                                    ...
                                    <tr>
										<td>
											<i class="fa fa-pencil-square-o" aria-hidden="true" id="<?php echo e($row->id); ?>" data-position="left" data-tooltip="Edit" onclick="javascript:return editvehicle(this);" style="cursor: pointer;"></i>
											<a href="<?php echo e(route('vehicle_delete.vehicleDelete', ['id' => $row->id])); ?>" onclick="return confirm('Do you want to delete?')">
												<i class="fa fa-trash-o" aria-hidden="true" style="cursor: pointer;"></i></a>
										</td>
                                        <td class=""><?php echo e($row->owner_name); ?></td>
                                        <td class="cls_reg_number"><?php echo e($row->reg_number); ?></td>
										<td class="cls_chassis_number"><?php echo e($row->chassis_number); ?></td>
                                        
 										<td><?php echo e($row->created_at !=''?date('d-m-Y H:i:s',strtotime($row->created_at)):''); ?></td>
 										
 										<td><?php echo e($row->updated_at !=''?date('d-m-Y H:i:s',strtotime($row->updated_at)):''); ?></td>
										<td class="cls_flag" ><?php if($row->flag=='1'): ?>
                                        	<label class='badge badge-success'>Active</label>
                                        	<?php else: ?>
                                        	<label class="badge badge-danger">Inactive</label>
                                        	<?php endif; ?>
                                        </td>  
                                        <td class="cls_engine_number" style="display: none;"><?php echo e($row->engine_number); ?></td>
                                        <td class="cls_vehicle_segment" style="display: none;"><?php echo e($row->vehicle_segment); ?></td>
                                        <td class="cls_purchase_date" style="display: none;"><?php echo e($row->purchase_date); ?></td>
                                        <td class="cls_add_blue_use" style="display: none;"><?php echo e($row->add_blue_use); ?></td>
                                        <td class="cls_engine_emmission_type" style="display: none;"><?php echo e($row->engine_emmission_type); ?></td>
                                        <td class="cls_ownerId" style="display: none;"><?php echo e($row->ownerId); ?></td>
                                        <td class="cls_vehicle_model" style="display: none;"><?php echo e($row->vehicle_model); ?></td>
						...
						<?php echo e($rowData->links('pagination.custom')); ?>
 ...
 <script>
	 $(document).ready(function () {
		...
		/* Ajax Datatable */
			...
			$.ajax({
				url: '<?php echo e(url("ajax-vehicle-report-data")); ?>',
