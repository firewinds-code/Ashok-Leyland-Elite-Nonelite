...
class ReportController extends Controller
{
	...
	public function storeConsolidatedReport(Request $request){
     ...
     // dd($tat);
      ...
      // caller_language  mstr_caller  , cal.caller_contact
  ...
  public function storeConsolidatedReportExcel(Request $request){
		try {
     // dd($request->input());
     ...
     // dd($tat);
      ...
      return Excel::download(new ReportExport($data), "Consolidated_Report_$dataR.xlsx");
     die;
